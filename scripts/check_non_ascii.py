...
EXCLUDE_RE = re.compile(
    ...
    # web/js/index.js and web/js/gallery_extension.js are bundled artifacts
    # generated by the build tool and may contain non-ASCII from third-party
    # sources. The "web/js/(gallery_extension|index)\.js$" subgroup in
    # EXCLUDE_RE is what excludes them.
    r"(\.ja\.|^docs/ja/|^\.cursor/rules/|^agent-config/rules/|^web/js/(gallery_extension|index)\.js$|^\.github/ISSUE_TEMPLATE/.*\.ja\.yml$|"
    r"i18n\.(ts|test\.ts)|README\.md|\.cursor/skills/.*\.md|agent-config/skills/.*\.md)"
)
