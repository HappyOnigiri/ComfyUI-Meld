...
import { FullScreenTab } from "./settings/tabs/FullScreenTab";
import { GeneralTab } from "./settings/tabs/GeneralTab";
import { SearchTab } from "./settings/tabs/SearchTab";
import { ShortcutsTab } from "./settings/tabs/ShortcutsTab";
import { SidebarTab } from "./settings/tabs/SidebarTab";
import { ViewTab } from "./settings/tabs/ViewTab";
